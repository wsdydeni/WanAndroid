...
interface LoadingStatusListener {
    fun onSuccess()
    fun onFailure()
}
...
class LoadingCircleView : View{
    ...
    private var loadingStatusListener: LoadingStatusListener? = null
    ...
    private var successAnimatorSet = AnimatorSet().apply {
        ...
        addListener(object : Animator.AnimatorListener {
            ...
            override fun onAnimationEnd(animation: Animator?) {
                loadingStatusListener?.onSuccess()
            }
        })
    }
    ...
    private var failureAnimatorSet = AnimatorSet().apply {
        ...
        addListener(object : Animator.AnimatorListener {
            ...
            override fun onAnimationRepeat(animation: Animator?) {}
            override fun onAnimationEnd(animation: Animator?) {
                loadingStatusListener?.onFailure()
            }
        })
    }
    ...
    fun setLoadingStatusListener(listener: LoadingStatusListener) {
        loadingStatusListener = listener
    }
    ...
    fun stopAllAnimator() {
        ...
        failureAnimatorSet.removeAllListeners()
    }
